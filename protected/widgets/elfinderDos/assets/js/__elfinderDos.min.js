 ...
 **/
window.elfinderDos = function(node, opts) {
	this.time('load');
	
	var self = this,
		
		/**
		 * Node on which elfinderDos creating
		 *
		 * @type jQuery
		 **/
		node = $(node),
	...
	this.dialog = function(content, options) {
		return $('<div/>').append(content).appendTo(node).elfinderDosdialog(options);
	}
	...
	this
		.enable(function() {
			if (!enabled && self.visible() && self.ui.overlay.is(':hidden')) {
				...
				node.removeClass('elfinderDos-disabled')
			}
		})
		.disable(function() {
			prevEnabled = enabled;
			enabled = false;
			node.addClass('elfinderDos-disabled');
		})
		.open(function() {
			selected = [];
		})
	...
	this.ui = {
		...
		workzone : $('<div/>').appendTo(node).elfinderDosworkzone(this),
		// container for folders tree / places
		navbar : $('<div/>').appendTo(node).elfinderDosnavbar(this, this.options.uiOptions.navbar || {}),
		// contextmenu
		contextmenu : $('<div/>').appendTo(node).elfinderDoscontextmenu(this),
		// overlay
		overlay : $('<div/>').appendTo(node).elfinderDosoverlay({
			show : function() { self.disable(); },
			hide : function() { prevEnabled && self.enable(); }
		}),
		// current folder container
		cwd : $('<div/>').appendTo(node).elfinderDoscwd(this),
		...
		statusbar : $('<div class="ui-widget-header ui-helper-clearfix ui-corner-bottom elfinderDos-statusbar"/>').hide().appendTo(node)
	}
