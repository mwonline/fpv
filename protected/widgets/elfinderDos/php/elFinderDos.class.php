...
class elfinderDos {
	 ...
	 * Constructor
	 *
	 * @param  array  elfinderDos and roots configurations
	 * @return void
	...
	public function __construct($opts) {
		...
		if (isset($opts['roots']) && is_array($opts['roots'])) {
			...
			foreach ($opts['roots'] as $i => $o) {
				$class = 'elfinderDosVolume'.$o['driver'];
	...
	/**
	 * Add handler to elfinderDos command
	 *
	 ...
	 * @return elfinderDosStorageDriver
	 * @author Dmitry (dio) Levashov
	 **/
