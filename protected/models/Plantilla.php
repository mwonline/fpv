...
class Plantilla extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idPlantilla, nombrePlantilla', 'required'),
			array('idPlantilla', 'numerical', 'integerOnly'=>true),
			array('nombrePlantilla', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idPlantilla, nombrePlantilla', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nombrePlantilla',$this->nombrePlantilla,true);
