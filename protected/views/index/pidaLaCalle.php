        ...
        <div class="left">
                    ...
                    <ul>
                        ...
                        <?php foreach ($mensajes_face as $mensaje_face):?>
                            <li>
                                ...
                                <div class="compartir" style="z-index:<?php echo $i;?>;">
                                    <div style="z-index:5;" class="fb-like" data-href="<?php echo Yii::app()->request->getBaseUrl(true)?>/index/categoria/<?php echo $model->alias ?>?idm=<?php echo $mensaje_face->id; ?>" data-width="100" data-layout="button_count" data-show-faces="false" data-send="false"></div>
                                </div>
                                <?php $i--;?>
                            </li>
                        <?php endforeach;?>                    
            ...
            <div class="otras-paginador">
                <?php 
                    ...
                    'htmlOptions'=>array('class'=>'', 'style'=>'width: 300px; margin-left: auto; margin-right: auto;'),
                    ));
                ?>
            </div>
        </div><!--fin left-->        
 ...
 <!--Compartir en redes sociales-->
                    <div class="compartir">
                        ...
                        <div  class="compartir-redes">
                            <div class="fb-like" data-href="<?php echo Yii::app()->request->getBaseUrl(true)?>/index/categoria/<?php echo $model->alias ?>" data-width="100" data-layout="button_count" data-show-faces="false" data-send="false" style="z-index:5;">
                            </div> 
